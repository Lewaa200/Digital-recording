...
builder.Services.AddScoped<IDigitalRecordingService, DigitalRecordingService>();
builder.Services.AddScoped<IDigitalRecordingRepository, DigitalRecordingRepository>();
